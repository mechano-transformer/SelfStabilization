...
##        return pulses
    ...
    def _read_errors(self):
        ...
        #current_x = 5000* math.tan(math.radian(current_x))  20260331
        current_y = self.master.alny_smooth if self.master.smoothing_enabled else self.master.alny
        #current_y = 5000* math.tan(math.radian(current_y))  20260331
